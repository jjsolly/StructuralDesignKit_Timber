...
namespace StructuralDesignKitLibrary.Connections.Interface
{
	public interface IFastener
	{
		...
		///// <param name="angle">Load angle toward the timber grain in degree</param>
		///// <param name="thickness">Optional argument for panel embedment strength calculation</param>
		///// <returns></returns>
		void ComputeEmbedmentStrength(IMaterialTimber timber, double angle, double thickness = 0);
		...
		/// </summary>
		/// <param name="timberDensity"></param>
		/// <returns></returns>
		double ComputeSlipModulus(double timberDensity);
